...
/**
 * MohallaChart - Displays property transaction analysis by locality (mohalla)
 * 
 * @param {Object} props
 ...
 */
const MohallaChart = ({ data = [], view = 'value', limit = 50 }) => {
        ...
        return (
            <div className="bg-white p-4 rounded-lg shadow">
                <div className="flex justify-between items-center mb-4">
                    <h3 className="text-lg font-medium">Property Values by Locality (Mohalla)</h3>
    ...
    if (view === 'pricePerSqm') {
        ...
        return (
            <div className="bg-white p-4 rounded-lg shadow">
                <div className="flex justify-between items-center mb-4">
                    <h3 className="text-lg font-medium">Price per Square Meter by Locality</h3>
                    <div className="text-sm font-medium text-emerald-700">
                        Showing {sortedData.length} localities
                    </div>
                </div>
    ...
    if (view === 'count') {
        ...
        return (
            <div className="bg-white p-4 rounded-lg shadow">
                <div className="flex justify-between items-center mb-4">
                    <h3 className="text-lg font-medium">Transaction Volume by Locality</h3>
                    <div className="text-sm font-medium text-blue-700">
                        Total: {overallStats.totalTransactions} transactions
                    </div>
                </div>
    ...
    return (
        <div className="bg-white p-4 rounded-lg shadow">
            <div className="flex justify-between items-center mb-4">
                <h3 className="text-lg font-medium">Land Type Distribution by Locality</h3>
                <div className="text-sm font-medium text-purple-700">
                    {landTypeData.length} localities analyzed
                </div>
            </div>
