...
//         subtitle: "Select a Tehsil/SRO and view related mohallas",
...
//         subtitle: "तहसील/एसआरओ का चयन करें और संबंधित मोहल्ला देखें",
...
//             alert('Please select both Tehsil and Village/Mohalla');
//             return;
//         }
...
//                     gaonCode1: selectedVillage.value,
//                     propertyId: '',
//                     propNEWAddress: '1'
//                 })
//             });
...
import React, { useState, useEffect } from 'react';
import { Search, Globe, Database, X, Terminal, ChevronDown, ChevronUp } from 'lucide-react';
import { useNavigate } from 'react-router-dom';
import { base_url } from '../utils/base_url';
...
const TehsilMohallaDashboard = () => {
    ...
    const startAutoProcessing = async (tehsil, villages) => {
        ...
        for (let i = 0; i < villages.length; i++) {
            if (!isProcessingBatch) break; // Allow cancellation
    ...
    return (
        <div className="flex flex-row min-h-screen bg-gray-50">
            ...
            <div className={`bg-gray-900 text-white transition-all duration-300 ${showConsole ? 'w-80' : 'w-12'}`}>
